...
mysqli_select_db($links,"douzo") or die(mysqli_error($links));
           ...
           $res=mysqli_query($links,"SELECT * from tbl_emp_sal where Emp_Id = $id");
...
<head>
    ...
    <title>Update Employee's Salary</title>
</head>
<style>
...
<div class="container">
    ...
    <?php
            ...
            while($row = $result->fetch_assoc()){
                echo "<p style='padding-top:120px;'>".$row["Emp_Id"]."</p>";
                echo "<p>".$row["Fname"]."</p>";
                echo "<p>".$row["Lname"]."</p>";
    ...
    ?>            
     <div class="contain">
        <div class="aligning">
        <form id="update" class="input-group" action = "db_empsal.php?Emp_Id=<?php echo $id?>" method="post">
                ...
                <!-- <input type="text" class="input-field" name ="Total_Salary" placeholder="Salary" required> -->
...
<br><br>
<br>
    <a href="../emp_sal.php"><button class="btn btn-primary col-5 m-3">Back</button></a>
    </div>
