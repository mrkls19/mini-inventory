...
<div class="box-section">
    ...
    <table class="table">
        ...
        <?php
            ...
            if(isset($_GET['id'])){
                $id=$_GET['id'];
              $delete= mysqli_query($con,"DELETE FROM `tbl_rec` WHERE `Prod_Id`='$id'");
            }
                        while($row = $result->fetch_assoc()){
                            echo "<tr>

                            <td><p>" . $row["Prod_Id"] . "</p></td>
                            <td><p>" . $row["Prod_name"] . "</p></td>
                            <td><p>" . $row["Prod_price"] . "</p></td>
                            <td><p>" . $row["Prod_exp"] . "</p></td>  
                            <td><p>" . $row["Category"] . "</p></td>";

                            if($row["Quantity"]<30){
                            echo "<td><p style='color: red;border-left: 3px solid red; font-size:13px;font-style:italic;'>" . $row["Quantity"] . " Low stock</p></td>";
                          }else{
