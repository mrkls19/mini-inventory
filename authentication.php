...
<div class="header">
    ...
    <table class="table">
        <thead>
            <tr>
                <th class="table-dark"><h6>Employee_ID</h6></th>
                <th class="table-dark"><h6>Code</h6></th>
                <th class="table-dark"><h6>Username</h6></th>
                <th class="table-dark"><h6>Firstname</h6></th>
                <th class="table-dark"><h6>Lastname</h6></th>
                <th class="table-dark"><h6>Password</h6></th>
...
?>
  ...
  <div class="topbar">
  <a href="authentication.php" id="close-modal"><h6 style="color:black;"><i class="bi bi-x-circle-fill"> </i>Close</h6></a>
</div>
  <div class="form-box">
...
<table class="table">
        <thead>
            <tr>
                <th class="table-dark"><h6>Employee_ID</h6></th>
                <th class="table-dark"><h6>First name</h6></th>
                <th class="table-dark"><h6>Last Name</h6></th>
                <th class="table-dark"><h6>Username</h6></th>
                <th class="table-dark"><h6>Employee Password</h6></th>
                <th class="table-dark"><h6>Position</h6></th>
                <th class="table-dark"><h6>Message</h6></th>
                <th class="table-dark"><h6>Action</h6></th>
            </tr>
        </thead>
        <tbody>
