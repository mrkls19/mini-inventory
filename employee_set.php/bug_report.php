...
<div class="btn-container">
    ...
    <h1>Bug Report</h1>
    <p>If you saw something like http status code or error in the website you can leave message here and we will comply as soon as possible.</p>
    <hr><hr>
    
    <div class="section-one">

        <div class="bot-section">
    <form id="request" class="input-group" action = "bug_rep_req.php" method="post">
            <input type="text" class="input-field" name ="id" placeholder="Employee ID" required>
